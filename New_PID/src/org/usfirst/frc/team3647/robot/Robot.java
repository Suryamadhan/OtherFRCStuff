	...
	public void newDrive()
	{
		...
		else if(prevState == 1)
		{
				...
				else
				{
					...
					else if(Math.abs(rightEncValue - leftEncValue) < 20)
					{
						if(rightEncValue > leftEncValue)
						{
							Motors007.leftTalon.set(leftValue);
						    Motors007.rightTalon.set(-leftValue + .125);
						}
						else
						{
							Motors007.leftTalon.set(leftValue - .125);
						    Motors007.rightTalon.set(-leftValue);
						}
					}
					else if(Math.abs(rightEncValue - leftEncValue) < 34)
					{
						if(rightEncValue > leftEncValue)
						{
							Motors007.leftTalon.set(leftValue);
						    Motors007.rightTalon.set(-leftValue + .2);
						}
						else
						{
							Motors007.leftTalon.set(leftValue - .2);
						    Motors007.rightTalon.set(-leftValue);
						}
					}
					else if(Math.abs(rightEncValue - leftEncValue) < 48)
					{
						if(rightEncValue > leftEncValue)
						{
							Motors007.leftTalon.set(leftValue);
						    Motors007.rightTalon.set(-leftValue + .275);
						}
						else
						{
							Motors007.leftTalon.set(leftValue - .275);
						    Motors007.rightTalon.set(-leftValue);
						}
					}
					else
